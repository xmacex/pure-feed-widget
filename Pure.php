...
class Pure
{
     ...
     */
    function __construct(string $url, string $apikey)
    {
        $this->url = $url;
        $this->apikey = $apikey;
    }
     ...
     * @param string $order     Sorting order, supported by the API
     * @param string $rendering Rendering type
     *
     * @return array Of publications
     *
     */
    function get_research_outputs(string $org=NULL, int $size=5, string $rendering='vancouver')
    {
     ...
     */
    function query(string $endpoint, SimpleXMLElement $query)
    {
